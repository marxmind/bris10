...
public static Map<Integer, Object> printDocumentV6(Clearance clr) {
		...
		if(com.italia.marxmind.bris.enm.Purpose.BUSINESS_NEW.getId()== clr.getPurposeType() || 
			...
			words = Words.getTagName("issued-date-office");
			...
			String words = Words.getTagName("asstance-burial-string-1");
			words = words.replace("<diedperson>", beneciaryName);
			words = words.replace("<civilstatus>", civilStatus);
			words = words.replace("<diedpersonaddress>", address);
			str.append(words);
			
			str.append(supportdtls);
			
			words = Words.getTagName("asstance-burial-string-2");
			words = words.replace("<heshe>", heshe);
			str.append(words);

			words = Words.getTagName("asstance-burial-string-3");
			words = words.replace("<requestor>", requestor);
			words = words.replace("<relationship>", relationship);
			words = words.replace("<diedperson>", beneciaryName);
			str.append(words);
			...
			String words = Words.getTagName("asstance-financial-string-1");
			words = words.replace("<patientname>", beneciaryName);
			words = words.replace("<age>", age+"");
			words = words.replace("<civilstatus>", civilStatus);
			words = words.replace("<patientaddress>", address);
			str.append(words);
			
			words = Words.getTagName("asstance-financial-string-2");
			words = words.replace("<heshe>", heshe);
			str.append(words);
			
			words = Words.getTagName("asstance-financial-string-3");
			words = words.replace("<requestor>", requestor);
			words = words.replace("<relationship>", relationship);
			str.append(words);
			...
			String words = Words.getTagName("asstance-medical-string-1");
			words = words.replace("<patientname>", beneciaryName);
			words = words.replace("<age>", age+"");
			words = words.replace("<civilstatus>", civilStatus);
			words = words.replace("<patientaddress>", address);
			words = words.replace("<hospital>", supportdtls.toUpperCase());
			str.append(words);		
			
			words = Words.getTagName("asstance-medical-string-2");
			if(DocTypes.CLEARANCE.getId()==clr.getDocumentType() || DocTypes.CLEARANCE_OPEN_TITLE.getId()==clr.getDocumentType()){
				...
				words = words.replace("<docttype>", DocTypes.INDIGENT.getName());
			}	
			words = words.replace("<requestor>", requestor);
			words = words.replace("<relationship>", relationship);
			str.append(words);
			...
			words = Words.getTagName("asstance-medical-string-5");
			...
			String words = Words.getTagName("asstance-calamity-string-1");
			words = words.replace("<requestor>", requestor);
			words = words.replace("<civilstatus>", civilStatus);
			words = words.replace("<requestoraddress>", address);
			str.append(words);	
			...
			words = Words.getTagName("asstance-calamity-string-2");
			...
			String words = Words.getTagName("asstance-indigent-string-1");
			words = words.replace("<patientname>", beneciaryName);
			words = words.replace("<age>", age+"");
			words = words.replace("<civilstatus>", civilStatus);
			words = words.replace("<patientaddress>", address);
			...
			words = Words.getTagName("asstance-indigent-string-2");
			...
			if(DocTypes.CLEARANCE.getId()==clr.getDocumentType() || DocTypes.CLEARANCE_OPEN_TITLE.getId()==clr.getDocumentType()){
				...
				words = words.replace("<docttype>", DocTypes.LOW_INCOME.getName());
			}	
			words = words.replace("<requestor>", requestor);
			words = words.replace("<relationship>", relationship);
			str.append(words);
			...
			String words = Words.getTagName("asstance-attorney-string-1");
			words = words.replace("<requestor>", requestor);
			words = words.replace("<civilstatus>", civilStatus);
			words = words.replace("<requestoraddress>", address);
			words = words.replace("<heshe>", heshe);
			...
			words = Words.getTagName("asstance-attorney-string-2");
			words = words.replace("<hisher>", hisher);
			if(DocTypes.CLEARANCE.getId()==clr.getDocumentType() || DocTypes.CLEARANCE_OPEN_TITLE.getId()==clr.getDocumentType()){
				words = words.replace("<docttype>", DocTypes.CLEARANCE.getName());
			}else if(DocTypes.CERTIFICATE.getId()==clr.getDocumentType() || DocTypes.CERTIFICATE_OPEN_TITLE.getId()==clr.getDocumentType()){
			...
			words = Words.getTagName("asstance-attorney-string-4");
			if(clr.getCedulaNumber()!=null && !clr.getCedulaNumber().isEmpty()){
				String[] ced = clr.getCedulaNumber().split("<:>");
			...
			String words = Words.getTagName("legal-string-1");
			if(DocTypes.CLEARANCE.getId()==clr.getDocumentType() || DocTypes.CLEARANCE_OPEN_TITLE.getId()==clr.getDocumentType()){
				words = words.replace("<docttype>", DocTypes.CLEARANCE.getName());
			}else if(DocTypes.CERTIFICATE.getId()==clr.getDocumentType() || DocTypes.CERTIFICATE_OPEN_TITLE.getId()==clr.getDocumentType()){
				words = words.replace("<docttype>", DocTypes.CERTIFICATE.getName());	
			...
			words = Words.getTagName("legal-string-2");
			words = words.replace("<heshe>", heshe);
			...
			String words = Words.getTagName("asstance-hospital-string-1");
			words = words.replace("<patientname>", beneciaryName);
			words = words.replace("<age>", age+"");
			words = words.replace("<civilstatus>", civilStatus);
			words = words.replace("<patientaddress>", address);
			...
			words = Words.getTagName("asstance-hospital-string-2");
			words = words.replace("<heshe>", heshe);
			str.append(words);	
			
			words = Words.getTagName("asstance-hospital-string-3");
			if(DocTypes.CLEARANCE.getId()==clr.getDocumentType() || DocTypes.CLEARANCE_OPEN_TITLE.getId()==clr.getDocumentType()){
				words = words.replace("<docttype>", DocTypes.CLEARANCE.getName());
			}else if(DocTypes.CERTIFICATE.getId()==clr.getDocumentType() || DocTypes.CERTIFICATE_OPEN_TITLE.getId()==clr.getDocumentType()){
				words = words.replace("<docttype>", DocTypes.CERTIFICATE.getName());	
			...
			String words = Words.getTagName("asstance-cert-string-1");
			...
			if(DocTypes.LOW_INCOME.getId()==clr.getDocumentType()){
				...
				words = Words.getTagName("asstance-cert-string-16");
				words = words.replace("<relationship>", rel);
				words = words.replace("<parents>", clr.getNotes());
				words = words.replace("<heshe>", heshe);
				str.append(words);	
			}else if(DocTypes.INCOME.getId()==clr.getDocumentType()){
				words = Words.getTagName("asstance-cert-string-17");
				words = words.replace("<heshe>", heshe);
				str.append(words);
