...
public class DateUtils {
	...
	public static void main(String[] args) {
		...
		*/
		/*for(int i=1; i<=31; i++){
			if(i<=9)
				System.out.println(DateUtils.dayNaming("0"+i+""));
			else
				System.out.println(DateUtils.dayNaming(i+""));
		}*/
		
		double age1 = 0.0;
		double age2 = 0.0;
		double age3 = 0.0;
		//String a="2015-12-09",b="2016-08-14",c="2016-10-14";
		String a="1984-09-19",b="1984-12-19",c="1986-10-18";
		//age1 = DateUtils.calculateAgeNow(a);
		//age2 = DateUtils.calculateAgeNow(b);
		//age3 = DateUtils.calculateAgeNow(c);
		//System.out.println(a+">> "+Math.round(age1));
		//System.out.println(b+">> "+Math.round(age2));
		//System.out.println(c+">> "+Math.round(age3));
		
		//System.out.println(a+">> "+age1);
		//System.out.println(b+">> "+age2);
		//System.out.println(c+">> "+age3);
		
		
		LocalDate birtdate = LocalDate.of(1984, 9, 19);
		System.out.println(birtdate);
		
		int actual = calculateAge(birtdate, LocalDate.of(2017, 12, 17));
