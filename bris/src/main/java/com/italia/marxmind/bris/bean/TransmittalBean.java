...
public class TransmittalBean implements Serializable {
	...
	private List<TransmittalRpt> transmittals;
	...
	private List<Transmittal> transactions;
	...
	private void loadTransactions() {
		transactions = new ArrayList<Transmittal>();
		String sql = "";
	...
	public void clickItem(Transmittal tr) {
		...
		List<TransmittalRpt> trans = new ArrayList<TransmittalRpt>();
	...
	public void loadMonthCheques() {
		transmittals = new ArrayList<TransmittalRpt>();
		...
		Map<String, BankChequeTrans> unsortCheck = new HashMap<String, BankChequeTrans>();
	...
	public void printTransmittalNew(Transmittal trn) {
		...
		List<TransmittalRpt> transRpt = new ArrayList<TransmittalRpt>();
		String sql = " AND bnk.bankrptisactive=1 AND (bnk.dateapplying>=? ANd bnk.dateapplying<=?)";
		String month = "";
		if(getMonthId()<=9) {
			month = "0"+getMonthId();
