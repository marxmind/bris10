...
public class Skinning implements Serializable{
	...
	private String sideBarMain;
	private String accordionPanelMain;
	private String tableMainSearch;
	...
	private static final String PROPERTY_FILE = Bris.PRIMARY_DRIVE.getName() + Bris.SEPERATOR.getName() +
			...
			Bris.APP_CONFIG_FLDR.getName() + Bris.SEPERATOR.getName() + "skin.bris";
	...
	public String getSideBarMain() {
		return sideBarMain;
	}

	public void setSideBarMain(String sideBarMain) {
	...
	public String getTableMainSearch() {
		return tableMainSearch;
	}

	public void setTableMainSearch(String tableMainSearch) {
		this.tableMainSearch = tableMainSearch;
	}
