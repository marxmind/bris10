...
public class Blotters {
	...
	private List<SuspectedPerson> suspectedPersons;
	private List<MinorPerson> minorPersons;
	private List<VictimPerson> victimPersons;
	private List<LuponPerson> luponPersons;
