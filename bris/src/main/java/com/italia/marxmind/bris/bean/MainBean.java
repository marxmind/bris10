...
public void viewModeListener() {
	...
	String showCitizenOnly =  citizenShow + cardHide + docHide + casesHide + showMainSearch + hideGenericSeach;
	String showCardOnly = cardShow + citizenHide + docHide + casesHide + hideMainSearch + showGenericSeach;
	String showDocOnly = docShow + citizenHide + cardHide +  casesHide + hideMainSearch + showGenericSeach;
	String showCasesOnly = casesShow + citizenHide + cardHide + docHide + hideMainSearch + showGenericSeach;
	//String showCalOnly = citizenHide + cardHide + docHide + casesHide + hideMainSearch + hideGenericSeach;
